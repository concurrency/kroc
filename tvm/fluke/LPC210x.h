 ...
 * $Revision: $
 *
 * Header file for Philips LPC210x ARM Processors.
...
// SPI Registers
#define SPCR            SPI->cr         /* Control Register */
#define SPSR            SPI->sr         /* Status Register */
#define SPDR            SPI->dr         /* Data Register */
#define SPCCR           SPI->ccr        /* Clock Counter Register */
#define SPINT           SPI->flag       /* Interrupt Flag Register */
...
// GPIO Registers
#define IOPIN           GPIO->in0       /* Pin Value Register */
#define IOSET           GPIO->set0      /* Pin Output Set Register */
#define IODIR           GPIO->dir0      /* Pin Direction Register */
#define IOCLR           GPIO->clr0      /* Pin Output Clear Register */
