...
TVM_INSTRUCTION (ins_dist)
{
	...
	STACK_RET (fired, UNDEFINE(BREG), UNDEFINE(CREG), STYPE_DATA, BREG, CREGt);
}
...
TVM_INSTRUCTION (ins_disc)
{
	...
	STACK_RET (fired, UNDEFINE(BREG), UNDEFINE(CREG), STYPE_DATA, BREGt, CREGt);
}
...
TVM_INSTRUCTION (ins_diss)
{
	...
	STACK_RET (fired, CREG, UNDEFINE(CREG), STYPE_DATA, CREGt, CREGt);
}
...
TVM_INSTRUCTION (ins_enbt)
{
	...
	STACK_RET (guard, CREG, UNDEFINE(CREG), STYPE_DATA, CREGt, CREGt);
}
