...
playerc_client_t *playerc_client_create(playerc_mclient_t *mclient,
                                        const char *array_host, int port);
...
/** @brief Add user callbacks (called when new data arrives). @internal
 FIXME: Kinda hoping that these two are not too important.  Don't know how to deal
 with function pointers yet.  They will probably just be INT's...  I hope.*/
...
//FIXME!  This uses a void dude.. hmm.  what do I do?
...
//FIXME: humm.  causes fail in compile, guess it does not like the non pointer structure.
