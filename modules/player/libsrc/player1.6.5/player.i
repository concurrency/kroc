...
%}
%include "stdint.i"
%include playerconfig.i
/*Adding typedefs for swig*/
...
typedef struct player_motor_velocitymode_config
{
  ...
  /** driver-specific */
  uint8_t value;
}  player_motor_velocitymode_config_t;
...
typedef struct player_motor_resetodom_config
{
  ...
  uint8_t request;
}  player_motor_resetodom_config_t;
...
typedef struct player_position_velocitymode_config
{
  ...
  /** driver-specific */
  uint8_t value; 
}  player_position_velocitymode_config_t;
...
typedef struct player_position_resetodom_config
{
  ...
  uint8_t request; 
}  player_position_resetodom_config_t;
...
player_position2d_velocitymode_config
{
  ...
  /** driver-specific */
  uint8_t value;
}  player_position2d_velocitymode_config_t;
...
typedef struct player_position2d_resetodom_config
{
  ...
  uint8_t request;
}  player_position2d_resetodom_config_t;
...
typedef struct player_position3d_velocitymode_config
{
  ...
  /** driver-specific */
  uint8_t value;
}  player_position3d_velocitymode_config_t;
...
typedef struct player_position3d_resetodom_config
{
  ...
  uint8_t request;
}  player_position3d_resetodom_config_t;
...
typedef struct player_ptz_controlmode_config
{
  ...
  uint8_t mode;
}  player_ptz_velocitymode_config_t;
...
#define PLAYER_CAMERA_IMAGE_SIZE 1228800 // which is ((640 * 480) * 4)
...
typedef struct player_map_data
{
  ...
  int8_t data[4079]; //[PLAYER_MAX_REQREP_SIZE - 17];
}  player_map_data_t;
