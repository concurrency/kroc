 ...
 * are not available.
 */
 /*WARNING: Changing the SDL_Surface union to an int.. coz it works that way
   otherwise it refuses to display anythign */
extern  SDL_Surface *  SDL_SetVideoMode
//extern  int *  SDL_SetVideoMode
...
/*SWIG: The two following functions are normally defined as macros in SDL
 ...
 the same thing as the original macros did..
...
*/
static inline int SDL_BlitSurface
