...
PRIVATE const struct instruction_struct
  ...
  } instructions[] =
  {
    ...
    /*}}}  */
    /*{{{  new process API */
    { I_PROC_ALLOC, "PROC_ALLOC", &trueval, GUYS_ATTR },
    { I_PROC_PARAM, "PROC_PARAM", &trueval, GUYS_ATTR },
    { I_PROC_MT_COPY, "PROC_MT_COPY", &trueval, GUYS_ATTR },
    { I_PROC_MT_MOVE, "PROC_MT_MOVE", &trueval, GUYS_ATTR },
    { I_PROC_START, "PROC_START", &trueval, GUYS_ATTR },
    { I_PROC_END, "PROC_END", &trueval, GUYS_ATTR },
    /*}}}*/
    /*{{{  mobile types */
    { I_MT_ALLOC, "MT_ALLOC", &trueval, GUYS_ATTR },
    { I_MT_RELEASE, "MT_RELEASE", &trueval, GUYS_ATTR },
    { I_MT_CLONE, "MT_CLONE", &trueval, GUYS_ATTR },
    { I_MT_IN, "MT_IN", &trueval, GUYS_ATTR },
    { I_MT_XCHG, "MT_XCHG", &trueval, GUYS_ATTR },
    { I_MT_LOCK, "MT_LOCK", &trueval, GUYS_ATTR },
    { I_MT_UNLOCK, "MT_UNLOCK", &trueval, GUYS_ATTR },
    { I_MT_ENROLL, "MT_ENROLL", &trueval, GUYS_ATTR },
    { I_MT_RESIGN, "MT_RESIGN", &trueval, GUYS_ATTR },
    { I_MT_SYNC, "MT_SYNC", &trueval, GUYS_ATTR },
    { I_MT_XIN, "MT_XIN", &trueval, GUYS_ATTR },
    { I_MT_XOUT, "MT_XOUT", &trueval, GUYS_ATTR },
    { I_MT_XXCHG, "MT_XXCHG", &trueval, GUYS_ATTR },
    { I_MT_DCLONE, "MT_DCLONE", &trueval, GUYS_ATTR },
    /*}}}*/
  };
/*}}}  */
