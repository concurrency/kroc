...
public class OccPlugFirmwareToolPanel extends JPanel
{
	...
	public static final String firmwareTargets[] = 
	{
...
*/
	...
	public OccPlugFirmwareToolPanel(OccPlug thePlug)
	{
		...
		arduinoPort.setSelectedItem(jEdit.getProperty(OccPlugPlugin.OPTION_PREFIX + "arduino.port"));
	...
	{
		jEdit.setProperty(OccPlugPlugin.OPTION_PREFIX + "arduino.port", (String)arduinoPort.getSelectedItem());
	}
	...
	{
		final OccPlug.DocumentWriter compileConsoleDoc = theOccPlug.new DocumentWriter(theOccPlug.getConsoleDoc());
		...
		firmdlCommand.add("-U");
		firmdlCommand.add("flash:w:" + OccPlugUtil.pathifyXXX("lib/tvm-arduino.hex"));
		firmdlCommand.add("-V");
		firmdlCommand.add("-F");
		firmdlCommand.add("-P"); 
		...
		ExecWorker execWorker = new ExecWorker(
	...
	// FIXME: This thing is probably too much like: NonInteractiveExecWorkerHelper in OccPlug.java
	class FirmwareDownloadExecWorkerHelper extends ExecWorkerHelper
	{
		protected final OccPlug.DocumentWriter compileConsoleDoc = theOccPlug.new DocumentWriter(theOccPlug.getConsoleDoc());
		...
		{
			compileConsoleDoc.writeError("FIXME: I should deal better with this: " + e + "\n");
