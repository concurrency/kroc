...
public class OccPlugUtil
{
	...
	/*
	 ...
	 {
	 this.occdocArgs = jEdit.getProperty(pfix + "occdocArgs", "").trim().split(",");
	 }
	 */
	...
	{
		return jEdit.getBooleanProperty("options.occPlug.slinker.optimalPrefixing",
				false);
	}

	/* FIXME:
	 * I would like to do a yes, no, ask, mode for this property 
	 */
  ...
  /**
	...
	public static boolean openWebBrowser(URL url)
	{
		...
		{ // Unix and other                                                                                                                           
			...
			/* FIXME: I'm going to ignore unix for now
			 String cmd =                                                                                                                
			 mergeStrings(Config.getPropString("browserCmd1"), url.toString());                                                                       
